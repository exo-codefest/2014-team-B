 ...
 */
package org.exoplatform.addons.codefest.team_b.core.test;
...
@ConfiguredBy({
  ...
  @ConfigurationUnit(scope = ContainerScope.PORTAL, path = "conf/standalone/exo.teamb.component.test.jcr-configuration.xml"),
  @ConfigurationUnit(scope = ContainerScope.PORTAL, path = "conf/standalone/exo.teamb.test.portal-configuration.xml"),
  @ConfigurationUnit(scope = ContainerScope.PORTAL, path = "conf/standalone/exo.teamb.test.jcr-configuration.xml"),
  @ConfigurationUnit(scope = ContainerScope.PORTAL, path = "conf/standalone/exo.teamb.component.core.test.configuration.xml")
})
